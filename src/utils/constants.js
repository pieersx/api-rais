...
export const IDENTIFIER_SCHEMES = {
  ...
  // Project
  PROJECT_REFERENCE:
    'https://w3id.org/cerif/vocab/IdentifierTypes#ProjectReference',
...
export const VOCABULARIES = {
  ...
  ORGUNIT_SECTOR_INSTITUTIONAL:
    'https://purl.org/pe-repo/ocde/sectorInstitucional',
  ORGUNIT_HIGHER_EDUCATION_TYPE:
    'https://purl.org/pe-repo/sunedu/tipoInstitucion',
  ...
  // Funding types
  OPENAIRE_FUNDING_TYPES:
    'https://www.openaire.eu/cerif-profile/vocab/OpenAIRE_Funding_Types',
...
export const PROJECT_TYPE_CONCYTEC_MAP = {
  // Mapeos CONCYTEC: solo incluir valores validados oficialmente
}
...
export const EQUIPMENT_TYPE_KEYWORDS = [
  ...
  [
    'ecogra',
    `${VOCABULARIES.CONCYTEC_EQUIPMENT_TYPES}#equiposDeImagenesMedicas`,
  ],
  [
    'tomogra',
    `${VOCABULARIES.CONCYTEC_EQUIPMENT_TYPES}#equiposDeImagenesMedicas`,
...
export const PROJECT_MEMBER_OCCUPATION_RULES = [
  [
    'tesista',
    `${VOCABULARIES.OCDE_OCCUPATION_TYPES}#investigadorOInnovadorMiembro`,
  ],
  [
    'asesor',
    `${VOCABULARIES.OCDE_OCCUPATION_TYPES}#investigadorOInnovadorMiembro`,
  ...
  [
    'tecnico',
    `${VOCABULARIES.OCDE_OCCUPATION_TYPES}#tecnicosYPersonalEquivalente`,
  ],
  [
    'auxiliar',
    `${VOCABULARIES.OCDE_OCCUPATION_TYPES}#personalAuxiliarODeApoyo`,
  ],
...
export const OAI_ERRORS = {
  ...
  noSetHierarchy:
    'The repository does not support sets or the set does not exist',
